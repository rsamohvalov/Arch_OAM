...
1. _Кратко описать предметную область, концепцию и задачи (функционал) приложения текстом._    
   ...
   __С учетом ограниченности по времени выполнения домашнего задания для реализации функционала управления агрегатом временно выбрана только работа с датчиками__  
